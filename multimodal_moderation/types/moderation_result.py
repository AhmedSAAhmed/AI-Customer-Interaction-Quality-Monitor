...
class AudioModerationResult(ModerationResult):
    ...
    is_unfriendly: bool = Field(default=False, description="Whether the audio shows unfriendly behavior or tone of voice")
    is_unprofessional: bool = Field(default=False, description="Whether the audio shows unprofessional tone or words")
